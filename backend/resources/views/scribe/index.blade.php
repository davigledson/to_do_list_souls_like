                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-DELETEapi-v1-users--id-">DELETE api/v1/users/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-todos">
                                <a href="#endpoints-GETapi-v1-todos">GET api/v1/todos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-todos">
                                <a href="#endpoints-POSTapi-v1-todos">POST api/v1/todos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-todos--id-">
                                <a href="#endpoints-GETapi-v1-todos--id-">GET api/v1/todos/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-todos--id-">
                                <a href="#endpoints-PUTapi-v1-todos--id-">PUT api/v1/todos/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-todos--id-">
                                <a href="#endpoints-DELETEapi-v1-todos--id-">DELETE api/v1/todos/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-tasks--id-">DELETE api/v1/tasks/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-xml-todos">
                                <a href="#endpoints-GETapi-xml-todos">GET api/xml/todos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-xml-todos--todo_id-">
                                <a href="#endpoints-GETapi-xml-todos--todo_id-">GET api/xml/todos/{todo_id}</a>
                            </li>
...
<p>The ID of the user. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-todos">GET api/v1/todos</h2>
...
<span id="example-requests-GETapi-v1-todos">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-v1-todos">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<code class="language-json" style="max-height: 300px;">[
    {
        &quot;id&quot;: 1,
        &quot;user_name&quot;: &quot;Jo&atilde;o&quot;,
        &quot;title&quot;: &quot;Lista de Compras&quot;,
        &quot;created_at&quot;: &quot;2025-09-05T20:22:44.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-09-05T20:22:44.000000Z&quot;,
        &quot;tasks&quot;: [
            {
                &quot;id&quot;: 2,
                &quot;todo_id&quot;: 1,
            ...
            },
            {
                ...
                &quot;is_completed&quot;: true,
                &quot;created_at&quot;: &quot;2025-09-05T20:22:44.000000Z&quot;,
                &quot;updated_at&quot;: &quot;2025-09-05T21:29:27.000000Z&quot;
            }
        ]
    },
    {
        &quot;id&quot;: 2,
        &quot;user_name&quot;: &quot;Maria&quot;,
        &quot;title&quot;: &quot;Estudos de Programa&ccedil;&atilde;o&quot;,
        &quot;created_at&quot;: &quot;2025-09-05T20:22:44.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-09-05T20:22:44.000000Z&quot;,
        &quot;tasks&quot;: [
            {
    ...
    },
    {
        ...
        &quot;created_at&quot;: &quot;2025-09-05T21:07:46.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-09-05T21:07:46.000000Z&quot;,
        &quot;tasks&quot;: []
    }
]</code>
 </pre>
    </span>
<span id="execution-results-GETapi-v1-todos" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-todos"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-todos"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-todos" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-todos">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-todos" data-method="GET"
      data-path="api/v1/todos"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-todos', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-todos"
                    onclick="tryItOut('GETapi-v1-todos');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-todos"
                    onclick="cancelTryOut('GETapi-v1-todos');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-todos"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-todos">POST api/v1/todos</h2>
...
<span id="example-requests-POSTapi-v1-todos">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-todos">
</span>
<span id="execution-results-POSTapi-v1-todos" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-todos"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-todos"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-todos" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-todos">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-todos" data-method="POST"
      data-path="api/v1/todos"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-todos', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-todos"
                    onclick="tryItOut('POSTapi-v1-todos');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-todos"
                    onclick="cancelTryOut('POSTapi-v1-todos');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-todos"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-todos--id-">GET api/v1/todos/{id}</h2>
...
<span id="example-requests-GETapi-v1-todos--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/todos/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-v1-todos--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-todos--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-todos--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-todos--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-todos--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-todos--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-todos--id-" data-method="GET"
      data-path="api/v1/todos/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-todos--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-todos--id-"
                    onclick="tryItOut('GETapi-v1-todos--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-todos--id-"
                    onclick="cancelTryOut('GETapi-v1-todos--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-todos--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-todos--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-todos--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-v1-todos--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the todo. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-todos--id-">PUT api/v1/todos/{id}</h2>
...
<span id="example-requests-PUTapi-v1-todos--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-todos--id-">
</span>
<span id="execution-results-PUTapi-v1-todos--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-todos--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-todos--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-todos--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-todos--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-todos--id-" data-method="PUT"
      data-path="api/v1/todos/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-todos--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-todos--id-"
                    onclick="tryItOut('PUTapi-v1-todos--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-todos--id-"
                    onclick="cancelTryOut('PUTapi-v1-todos--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-todos--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-todos--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-todos--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-v1-todos--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the todo. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-v1-todos--id-"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-todos--id-">DELETE api/v1/todos/{id}</h2>
...
<span id="example-requests-DELETEapi-v1-todos--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-todos--id-">
</span>
<span id="execution-results-DELETEapi-v1-todos--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-todos--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-todos--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-todos--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-todos--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-todos--id-" data-method="DELETE"
      data-path="api/v1/todos/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-todos--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-todos--id-"
                    onclick="tryItOut('DELETEapi-v1-todos--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-todos--id-"
                    onclick="cancelTryOut('DELETEapi-v1-todos--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-todos--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-todos--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-todos--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-v1-todos--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the todo. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="todo_id"                data-endpoint="POSTapi-v1-tasks"
               value="architecto"
               data-component="body">
    <br>
...
<p>The ID of the task. Example: <code>2</code></p>
                    ...
                    <h2 id="endpoints-GETapi-xml-todos">GET api/xml/todos</h2>
...
<span id="example-requests-GETapi-xml-todos">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/xml/todos" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-xml-todos">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<code class="language-json" style="max-height: 300px;">&lt;?xml version=&quot;1.0&quot;?&gt;
&lt;todos&gt;&lt;todo&gt;&lt;id&gt;1&lt;/id&gt;&lt;title&gt;Lista de Compras&lt;/title&gt;&lt;user_name&gt;Jo&amp;#xE3;o&lt;/user_name&gt;&lt;created_at&gt;2025-09-05 20:22:44&lt;/created_at&gt;&lt;tasks&gt;&lt;task&gt;&lt;id&gt;2&lt;/id&gt;&lt;title&gt;Comprar leite&lt;/title&gt;&lt;description&gt;Caixa de 12 unidades&lt;/description&gt;&lt;is_completed&gt;true&lt;/is_completed&gt;&lt;/task&gt;&lt;task&gt;&lt;id&gt;1&lt;/id&gt;&lt;title&gt;Comprar arroz&lt;/title&gt;&lt;description&gt;Pacote de 5kg&lt;/description&gt;&lt;is_completed&gt;true&lt;/is_completed&gt;&lt;/task&gt;&lt;/tasks&gt;&lt;/todo&gt;&lt;todo&gt;&lt;id&gt;2&lt;/id&gt;&lt;title&gt;Estudos de Programa&amp;#xE7;&amp;#xE3;o&lt;/title&gt;&lt;user_name&gt;Maria&lt;/user_name&gt;&lt;created_at&gt;2025-09-05 20:22:44&lt;/created_at&gt;&lt;tasks&gt;&lt;task&gt;&lt;id&gt;3&lt;/id&gt;&lt;title&gt;Estudar Laravel&lt;/title&gt;&lt;description&gt;Focar em migrations e seeders&lt;/description&gt;&lt;is_completed&gt;false&lt;/is_completed&gt;&lt;/task&gt;&lt;/tasks&gt;&lt;/todo&gt;&lt;todo&gt;&lt;id&gt;3&lt;/id&gt;&lt;title&gt;Tarefas do Trabalho&lt;/title&gt;&lt;user_name&gt;Carlos&lt;/user_name&gt;&lt;created_at&gt;2025-09-05 20:22:44&lt;/created_at&gt;&lt;tasks/&gt;&lt;/todo&gt;&lt;todo&gt;&lt;id&gt;4&lt;/id&gt;&lt;title&gt;cachorro quente&lt;/title&gt;&lt;user_name&gt;davi&lt;/user_name&gt;&lt;created_at&gt;2025-09-05 21:07:46&lt;/created_at&gt;&lt;tasks/&gt;&lt;/todo&gt;&lt;/todos&gt;
</code>
 </pre>
    </span>
<span id="execution-results-GETapi-xml-todos" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-xml-todos"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-xml-todos"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-xml-todos" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-xml-todos">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-xml-todos" data-method="GET"
      data-path="api/xml/todos"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-xml-todos', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-xml-todos"
                    onclick="tryItOut('GETapi-xml-todos');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-xml-todos"
                    onclick="cancelTryOut('GETapi-xml-todos');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-xml-todos"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-xml-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-xml-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-xml-todos--todo_id-">GET api/xml/todos/{todo_id}</h2>
...
<span id="example-requests-GETapi-xml-todos--todo_id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/xml/todos/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/xml/todos/1"
);
...
<span id="example-responses-GETapi-xml-todos--todo_id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<code class="language-json" style="max-height: 300px;">&lt;?xml version=&quot;1.0&quot;?&gt;
&lt;todo&gt;&lt;id&gt;1&lt;/id&gt;&lt;user_name&gt;Jo&amp;#xE3;o&lt;/user_name&gt;&lt;title&gt;Lista de Compras&lt;/title&gt;&lt;created_at&gt;2025-09-05T20:22:44.000000Z&lt;/created_at&gt;&lt;updated_at&gt;2025-09-05T20:22:44.000000Z&lt;/updated_at&gt;&lt;id&gt;2&lt;/id&gt;&lt;todo_id&gt;1&lt;/todo_id&gt;&lt;title&gt;Comprar leite&lt;/title&gt;&lt;balance&gt;0.00&lt;/balance&gt;&lt;description&gt;Caixa de 12 unidades&lt;/description&gt;&lt;is_completed&gt;1&lt;/is_completed&gt;&lt;created_at&gt;2025-09-05T20:22:44.000000Z&lt;/created_at&gt;&lt;updated_at&gt;2025-09-05T20:22:44.000000Z&lt;/updated_at&gt;&lt;id&gt;1&lt;/id&gt;&lt;todo_id&gt;1&lt;/todo_id&gt;&lt;title&gt;Comprar arroz&lt;/title&gt;&lt;balance&gt;0.00&lt;/balance&gt;&lt;description&gt;Pacote de 5kg&lt;/description&gt;&lt;is_completed&gt;1&lt;/is_completed&gt;&lt;created_at&gt;2025-09-05T20:22:44.000000Z&lt;/created_at&gt;&lt;updated_at&gt;2025-09-05T21:29:27.000000Z&lt;/updated_at&gt;&lt;/todo&gt;
</code>
 </pre>
    </span>
<span id="execution-results-GETapi-xml-todos--todo_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-xml-todos--todo_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-xml-todos--todo_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-xml-todos--todo_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-xml-todos--todo_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-xml-todos--todo_id-" data-method="GET"
      data-path="api/xml/todos/{todo_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-xml-todos--todo_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-xml-todos--todo_id-"
                    onclick="tryItOut('GETapi-xml-todos--todo_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-xml-todos--todo_id-"
                    onclick="cancelTryOut('GETapi-xml-todos--todo_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-xml-todos--todo_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/xml/todos/{todo_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-xml-todos--todo_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-xml-todos--todo_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="todo_id"                data-endpoint="GETapi-xml-todos--todo_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the todo. Example: <code>1</code></p>
...
<code class="language-json" style="max-height: 300px;">rota funcionando!</code>
 </pre>
    </span>
